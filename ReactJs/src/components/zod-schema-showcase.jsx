        ...
        <Sidebar className="flex-shrink-0">
          ...
          <SidebarContent className="flex flex-col h-[calc(100vh-4rem)]">
            <SidebarMenu className="px-4 flex-grow">
              {Object.keys(collections).map((collectionName) => (
                <SidebarMenuItem key={collectionName}>
                  ...
                  >
                    {collections[collectionName].name}
                  </SidebarMenuButton>
                </SidebarMenuItem>
              ))}
              <SidebarMenuItem>
            ...
            <div className="p-4 text-sm text-gray-500 border-t">
               A9 {new Date().getFullYear()} Bishoy Labib. MIT License.
            </div>
          </SidebarContent>
        </Sidebar>
          ...
          <div className="h-full flex flex-col">
            <div className="flex items-center justify-between p-4 border-b">
              <div className="flex items-center">
                <SidebarTrigger />
                <h1 className="text-2xl font-bold ml-4">{collections[activeCollection].name}</h1>
              </div>
              <a 
            ...
            <div className="flex-grow overflow-auto">
              <ZodSchemaDesigner
                ...
                initialSchema={collections[activeCollection]}
                onSave={handleSave}
